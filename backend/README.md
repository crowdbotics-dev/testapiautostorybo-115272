...
## Project Structure
    ...
    ├── testapiautostorybo_115272  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_115272`
...
2. Clone this repo and `cd testapiautostorybo_115272`
